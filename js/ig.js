...
window.Instagram = {
	...
	getTOKEN: function(callback) {
		$.ajax({
			type: 'GET',
			url: 'https://api.instagram.com/oauth/access_token?client_id=' + this.config.client_id + "&client_secret=" + this.config.client_secret + "&grant_type=authorization_code&redirect_uri=http://www.treetopadventurepark.com/newtreetop/igtest/igtest.php&code=" + this.config.code + "",
			dataType: 'jsonp',
			success: function(response){
